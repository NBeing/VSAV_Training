...
menu = {
      ...
      },
    {
        ...
        entries = {
            ...
            list_menu_item("Counter Attack Type", training_settings, "counter_attack", counter_attack_type, 0),
            ...
            integer_menu_item("Guard Action Delay", training_settings, "gc_delay", 0, 15, false, 20),
